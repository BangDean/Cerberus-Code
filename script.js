...
// Intersection Observer untuk Section Animation
...
const observerCallback = (entries, observer) => {
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            // Tambah class visible saat masuk viewport
            entry.target.classList.add('section-visible');
        } else {
            // Hapus class visible saat keluar viewport (untuk animasi berulang)
...
// Observe semua section dengan class section-animate
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    // Trigger animasi untuk section pertama (home) saat load
